...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        .setDescription(`Avaible commands for user ${message.author}\n\n**help**, **ping**, **botnotifications**, **mute**, **unmute**, **kick**, **ban**, **unban**, **purge**`)
        ...
        .setColor(0xe20000)
        .setTitle("Lucifer Bot")
        .setDescription(`Avaible commands for user ${message.author}\n\n**help**, **ping**, **botnotifications**, **mute**, **unmute**, **kick**, **purge**`)
        .setFooter(message.id)
        .setTimestamp()
        ...
        .setColor(0xe20000)
        .setTitle("Lucifer Bot")
        .setDescription(`Avaible commands for user ${message.author}\n\n**help**, **ping**, **botnotifications**, **mute**, **unmute**, **purge**`)
        .setFooter(message.id)
        .setTimestamp()
